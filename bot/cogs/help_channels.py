...
class HelpChannels(Scheduler, commands.Cog):
    ...
    * Channels are used to refill the Available category
    ...
    @staticmethod
    def get_alphabetical_position(channel: discord.TextChannel) -> t.Optional[int]:
        """
    ...
    def get_used_names(self) -> t.Set[str]:
        ...
        if len(names) > 50:
            log.warning("Too many help channels! Discord only supports 50 in a category.")
